...
The resulting document lives in `ai_docs/context/project_docs/project_charter.md`. It becomes the business foundation for all subsequent specifications.
...
Your PRD lives in `ai_docs/context/project_docs/prd.md` and becomes the definitive source for what your system should do.
...
The ADD in `ai_docs/context/project_docs/add.md` becomes your technical blueprint, ensuring all developers understand the system architecture.
...
Your WBS in `ai_docs/context/project_docs/wbs.md` becomes a living document that tracks project progress.
