...
The AI will engage you in consultation about business objectives, target market, success metrics, and constraints. This creates `ai_docs/context/project_docs/project_charter.md`.
...
Building on the charter, the AI helps define user personas, user journeys, functional requirements, and acceptance criteria. This creates `ai_docs/context/project_docs/prd.md`.
...
The AI consults on technical architecture, helping you make decisions about system topology, technology stack, and integration patterns. This creates `ai_docs/context/project_docs/add.md`.
...
Transform architecture into actionable tasks with complexity ratings and dependencies. This creates `ai_docs/context/project_docs/wbs.md`.
...
```bash
# Read existing documentation
cat ai_docs/context/project_docs/prd.md
cat ai_docs/context/project_docs/wbs.md
...
```bash
# Business context:
cat ai_docs/context/project_docs/project_charter.md

# What we're building:
cat ai_docs/context/project_docs/prd.md

# How it's built:
cat ai_docs/context/project_docs/add.md
